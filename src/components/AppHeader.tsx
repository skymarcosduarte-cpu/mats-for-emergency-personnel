  ...
  return (
    <header className="app-header">
      ...
      <button
        ...
        className="relative w-12 h-12 rounded-full bg-panic text-primary-foreground shadow-panic flex items-center justify-center touch-target animate-pulse-panic"
