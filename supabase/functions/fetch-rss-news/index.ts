...
// High-priority, WORKING sources only (removed feeds returning 404/403)
const PRIORITY_FEEDS: { url: string; source: string; category: string }[] = [
  // Mexico - Nacionales (only working feeds)
  ...
  // Internacionales (only working feeds)
