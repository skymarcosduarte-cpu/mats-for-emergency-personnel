...
-- Fix user_locations policies - recreate as PERMISSIVE (default)
-- The current policies appear to be RESTRICTIVE, blocking all operations
...
-- Recreate as PERMISSIVE (default behavior when AS RESTRICTIVE is not specified)
